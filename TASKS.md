...
- [x] Camera plate scan + weekly nutrition review (@cursor/camera-ai-scan-8acf)
  ...
  - **Acceptance**: Upload/capture plate → preview visible → description/nutrition/gaps → saved in DB. Weekly tab summarizes the week’s meals and gaps. Works without AI key (stub). EN/NL. Smoke + CHANGELOG.
